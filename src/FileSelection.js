...
class FileSelection extends Component {
  ...
  render() {
    ...
    if (showGallery) {
      return (
        <Gallery
          onClose={this.handleCloseGalleryClick}
    ...
    return (
      <div style={styles.container}>
        <h1 style={styles.title}>
          Azeem Sketch anything you want using your phone as a guide
        </h1>
        <hr style={styles.hr} />
        <ol style={styles.list}>
          ...
          <li style={styles.listItem}>Put it on a sheet of paper</li>
          <li style={styles.listItem}>
            Choose something to draw
            <div>
              <RaisedButton
                style={styles.btnFileInput}
                secondary
                fullWidth
                htmlFor="file_input"
            ...
            <RaisedButton
              secondary
              fullWidth
              onTouchTap={this.handleOpenGalleryClick}
              label="Our drawings"
            />
          </li>
        </ol>
